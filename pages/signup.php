...
<body>
    <div class="container mt-4 mb-4">
        ...
        <form action="signup.php" method="POST">
            ...
            <label>Last Name:<br><input type="text" name="last_name" value="<?php echo (isset($_POST['last_name'])) ? $_POST['last_name'] : ''; ?>"></label><br>
            <small><?php echo (isset($errors['last_name'])) ? $errors['last_name'] : ''; ?></small>

            <label>Address:<br><input type="text" name="address" value="<?php echo (isset($_POST['address'])) ? $_POST['address'] : ''; ?>"></label><br>
            <small><?php echo (isset($errors['address'])) ? $errors['address'] : ''; ?></small>

            <label>City:<br><input type="text" name="city" value="<?php echo (isset($_POST['city'])) ? $_POST['city'] : ''; ?>"></label><br>
            <small><?php echo (isset($errors['city'])) ? $errors['city'] : ''; ?></small>

            <label>State:<br><input type="text" name="state" value="<?php echo (isset($_POST['state'])) ? $_POST['state'] : ''; ?>"></label><br>
            <small><?php echo (isset($errors['state'])) ? $errors['state'] : ''; ?></small>

            <label>Zip Code:<br><input type="number" name="zipcode" value="<?php echo (isset($_POST['zipcode'])) ? $_POST['zipcode'] : ''; ?>"></label><br>
            <small><?php echo (isset($errors['zipcode'])) ? $errors['zipcode'] : ''; ?></small>

            <label>Budget:<br><input type="number" name="budget" value="<?php echo (isset($_POST['budget'])) ? $_POST['budget'] : ''; ?>"></label><br>
        ...
        <form action="login.php" method="POST">
            <input type="submit" class='btn secondary' value="Existing User? Login." />
        </form>

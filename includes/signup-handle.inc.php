...
if (isset($_POST['signup'])) {
    ...
    else if (preg_match($pattern, $_POST["password"]) === false) {
        $errors["pwd_pattern"] = "Password should have at least eight characters, including one letter and one number";
    }
    ...
    //if there are no empty fields, proceed
    if (count($errors) == 0) {
